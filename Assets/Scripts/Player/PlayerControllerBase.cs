...
public abstract class PlayerControllerBase<TData> : MonoBehaviour, IInputControllable where TData : PlayerDataAssetBase
{
	...
	/// スプリント/ワープ入力の購読
	/// </summary>
	protected virtual void OnSprintOrWarp(InputAction.CallbackContext context)
	{
		isSprintInput = true;
	}
	...
	/// スプリント/ワープ入力の購読
	/// </summary>
	protected virtual void OnSprintOrWarpCancel(InputAction.CallbackContext context)
	{
		isSprintInput = false;
	}
