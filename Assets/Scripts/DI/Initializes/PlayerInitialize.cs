...
namespace HCSMeta.Function.Injection.Exception
{
    public class DependencyInjectionException : System.Exception
    {
        ...
        public DependencyInjectionException(string message, System.Exception innerException)
        {
